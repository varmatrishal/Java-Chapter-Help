/** A test of the methods remove and clear, as defined in the class ArrayBag.
    ...
    NB: Version 3 of ArrayBag is the same as the final version. This driver tests only
        the additional methods. ArrayBagDemo tests all of the methods.
...
public class ArrayBagDemo3
{
   ...
   // Tests the method isEmpty; correctResult indicates what isEmpty should return.
